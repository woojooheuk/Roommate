...
public class ButtonController2 : MonoBehaviour
{
    ...
    public float distanceFromCamera = 15f; // 메인 카메라로부터의 거리
    private GameObject spawnedPrefab; // 생성된 프리펩 추적 변수
    public Vector3 defaultScale = new Vector3(0.1f, 1f, 0.1f);
    ...
    public void SpawnRoom()
    {
        ...
        else
        {
            ...
            // 프리펩의 크기 조절 
            spawnedPrefab.transform.localScale = defaultScale * 0.1f;
        ...
        if (buttonText != null)
        {
            buttonText.text = (isPrefabSpawned) ? "방 생성" : "지우기";
        }
